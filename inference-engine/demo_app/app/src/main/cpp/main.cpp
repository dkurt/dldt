...
int run_infer() {
    try {
		...
		//set all args to local
		bool FLAGS_p_msg=true;
		string FLAGS_d="CPU";
		string FLAGS_l="";
		string FLAGS_m="/data/local/tmp/squeezenet1.1.xml";
		int FLAGS_nt=10;
		...
		imageNames.push_back("/data/local/tmp/car.bmp");
...
Java_com_example_myapplication_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
    std::string hello = "Hello and infer --> from C++";
    __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "Run infer ...");
	run_infer();
