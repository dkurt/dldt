...
function(set_ie_threading_interface_for TARGET_NAME)
    ...
    if (THREADING STREQUAL "TBB" OR THREADING STREQUAL "TBB_AUTO")
        ...
        if (NOT TBB_INCLUDE_DIRS OR NOT TBB_LIBRARIES_RELEASE)
            ...
            if (WIN32)
                target_link_libraries(${TARGET_NAME} PRIVATE "-nodefaultlib:vcomp")
            endif ()

            # Debug binaries are optional.
            if (TBB_LIBRARIES_DEBUG)
                if (WIN32)
                    target_link_libraries(${TARGET_NAME} PRIVATE "$<$<CONFIG:DEBUG>:${TBB_LIBRARIES_DEBUG}>;$<$<NOT:$<CONFIG:DEBUG>>:${TBB_LIBRARIES_RELEASE}>")
                else ()
                    if ("${CMAKE_BUILD_TYPE}" STREQUAL "Debug")
                        target_link_libraries(${TARGET_NAME} PRIVATE ${TBB_LIBRARIES_DEBUG})
                    else()
                        target_link_libraries(${TARGET_NAME} PRIVATE ${TBB_LIBRARIES_RELEASE})
                    endif ()
                endif ()
            else ()
